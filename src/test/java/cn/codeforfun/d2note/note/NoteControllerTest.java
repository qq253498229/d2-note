...
public class NoteControllerTest {
    ...
    public void getAllNote() throws Exception {
        given(noteService.getAllNote(any())).willReturn(Arrays.asList(new Note(), new Note()));
    ...
    public void save() throws Exception {
        given(noteService.save(any(), any())).willReturn(new Note(1L, "tlx-xl"));
        mock.perform(
                post("/note")
    ...
    public void findByIdFetch() throws Exception {
        given(noteService.findById(any(), any())).willReturn(new Note(1L, "tlx-xl"));
